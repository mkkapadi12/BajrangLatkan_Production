...
export default function WorkersPage() {
 ...
 const [workers, setWorkers] = useState([])
  ...
  const [filters, setFilters] = useState({ name: '', role: '', status: '', sortBy: '' })
        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="max-w-2xl mx-auto text-xl text-purple-100">
              Meet our skilled craftsmen and team members who bring our latkans to life
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white sm:p-5 md:p-10 lg:p-15">
        <div className="container p-4 mx-auto">
          ...
          <div className="flex flex-col items-center justify-between mb-8 md:flex-row">
            <h2 className="mb-4 text-3xl font-bold text-gray-900 md:mb-0">Workers Management</h2>
          ...
          <div className="grid gap-4 mb-8 md:grid-cols-4">
            <div className="relative">
              ...
              <Input type="text" name="name" onChange={handleFilterChange} value={filters.name} placeholder="Filter by name..." className="pl-10" />
            </div>
            <Input type="text" name="role" onChange={handleFilterChange} value={filters.role} placeholder="Filter by role..." />
        ...
        <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Add New Worker">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {workers.map((worker) => (
              <Card key={worker._id} className="transition-shadow border-purple-100 hover:shadow-lg">
                <CardHeader className="pb-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <CardDescription className="text-gray-600">{worker.role}</CardDescription>
                    </div>
                    <Badge
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-600">{worker.experience} years</span>
                    </div>
                    <div className="flex items-center justify-between pt-2">
                      <span className="text-lg font-bold text-purple-600">₹{worker.salary}/month</span>
                      <div className="space-x-2">
                        <Button size="sm" variant="outline" onClick={() => navigate(`/workers/${worker._id}`)}>
                          View Details
                        </Button>
                      </div>
                    </div>
      ...
      <section className="py-20 bg-purple-50 sm:px-10 md:px-15 lg:px-20">
        <div className="container px-4 mx-auto">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">Workforce Statistics</h2>
            <p className="text-xl text-gray-600">Overview of our team performance and metrics</p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <Card className="text-center border-purple-100">
              <CardHeader>
                ...
                <CardTitle className="text-3xl font-bold text-purple-600">24</CardTitle>
            ...
            <Card className="text-center border-purple-100">
              <CardHeader>
                ...
                <CardTitle className="text-3xl font-bold text-green-600">22</CardTitle>
            ...
            <Card className="text-center border-purple-100">
              <CardHeader>
                ...
                <CardTitle className="text-3xl font-bold text-yellow-600">2</CardTitle>
            ...
            <Card className="text-center border-purple-100">
              <CardHeader>
                ...
                <CardTitle className="text-3xl font-bold text-blue-600">2.5</CardTitle>
